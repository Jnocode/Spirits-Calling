...
| package.launch | blocked | `Saved/Validation/package_launch.json` |

## Gates

| ID | Owner | Priority | Status | Evidence | Failure / resolution |
|---|---|---|---|---|---|
| preflight.build | release-engineering | P0 | pass | `Binaries/Win64/Spirits_Calling.exe` |  |
| preflight.audio | release-engineering | P0 | fail | `RawAssets/Audio` | raw/imported/cooked=9/9/0; ambient=blocked; report=D:\Workspace\03_Dev_Projects\Spirits-Calling\Spirits_Calling\Saved\Validation\audio_validation.json (open) |
...
| preflight.version | release-engineering | P0 | pass | `Config/DefaultGame.ini` |  |
| preflight.package | release-engineering | P0 | not_run | `evidence/missing/preflight.package.missing` | 尚未打包（P0-5 待做） (open) |
| preflight.release_scope | release-engineering | P0 | pass | `Docs/Release/Release_Materials/scope.md` |  |
...
| release.audio.imports | audio-import-owner | P0 | blocked | `Saved/Validation/audio_validation.json` | report does not contain complete locatable live evidence (open) |
| validation.package_closure | release-engineering | P0 | not_run | `evidence/missing/validation.package_closure.missing` | live validation report not supplied (open) |
| validation.package_launch | release-engineering | P0 | blocked | `Saved/Validation/package_launch.json` | report does not contain complete locatable live evidence (open) |
| validation.version_consistency | release-engineering | P0 | pass | `Saved/Validation/version_consistency.json` |  |

## Unresolved Issues

| ID | Gate | Reason | Evidence | Resolution |
|---|---|---|---|---|
| preflight.audio.issue | preflight.audio | raw/imported/cooked=9/9/0; ambient=blocked; report=D:\Workspace\03_Dev_Projects\Spirits-Calling\Spirits_Calling\Saved\Validation\audio_validation.json | `RawAssets/Audio` | open |
...
| validation.package_closure.issue | validation.package_closure | live validation report not supplied | `evidence/missing/validation.package_closure.missing` | open |
| validation.package_launch.issue | validation.package_launch | report does not contain complete locatable live evidence | `Saved/Validation/package_launch.json` | open |
| release.audio.imports.issue | release.audio.imports | report does not contain complete locatable live evidence | `Saved/Validation/audio_validation.json` | open |
...
```json
{
  "sequence": 1,
  "step": "A2 音效素材",
  "reason": "raw/imported/cooked=9/9/0; ambient=blocked; report=D:\\Workspace\\03_Dev_Projects\\Spirits-Calling\\Spirits_Calling\\Saved\\Validation\\audio_validation.json",
  "logPath": "RawAssets/Audio",
  "timestamp": "2026-07-23T15:26:58Z"
}
```
...
- `gates[22].evidencePath` **unlocatable**: gate evidence path does not exist
